...
class LearnedGradientDescentOptimizer(nn.Module, OptimizerBase):
    ...
    def __init__(self, degradation: DegradationBase, optimizer_network: nn.Module, num_steps: int,
                 ...
                 hidden_state_num_channels: int = None, use_gradlikelihood_input: bool = True) -> None:
        """
        ...
        self.use_gradlikelihood_input = use_gradlikelihood_input
    ...
    def perform_step(self, latent_images: th.Tensor, degraded_images: th.Tensor,
        ...
        """
        if self.use_gradlikelihood_input:
    ...
    def restore(self, degraded_images: th.Tensor, track_updates_history: bool = False) -> Union[List[th.Tensor], th.Tensor]:
        """
